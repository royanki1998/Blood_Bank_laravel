...
<html dir="ltr">
  <head>
    ...
    <title>Donation Form Male</title>
    <style>
        .form-label{
            color: white;
            font-size: 15px;
        ...
        <div class="auth-box">
            <div>
                <div class="text-center text-white py-4 mb-4">
                    <h2>Donation Form [Male]</h2>
                    <p class="text-danger">[ Information provided through this form must be true to the knowledge of the donor
                         and should be verified at the donation center with his valid ID proofs, at the fullfillment of which he must 
